...
| **5** | Networking + badges                  | 🟡 Spec'd, not started          | Scan model scaffolds an `attendee` target (0 pts today); no badges/achievements yet. Scope spec: **`CLAUDE-phase5.md`** (networking scans + badge engine; scanner-only payout, seed-driven badges in v1).                                                                                       |
